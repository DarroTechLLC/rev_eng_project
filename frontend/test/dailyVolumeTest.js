...
describe('DailyVolumeController Tests', () => {
  ...
  test('Controller should initialize correctly', () => {
    ...
    expect(consoleLogSpy).toHaveBeenCalledWith(
      expect.stringContaining('DailyVolumeController initialized')
    );
  });
  ...
  test('log method should format messages correctly', () => {
    ...
    expect(consoleLogSpy).toHaveBeenCalledWith(
      expect.stringContaining('Test with data - Data: {"key":"value"}')
    );
  ...
  test('showError should display error message and enable debug mode', () => {
