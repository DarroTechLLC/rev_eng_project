...
console.log('📊 Initializing Area Chart with custom font settings');
Chart.defaults.global.defaultFontFamily = 'Nunito', '-apple-system,system-ui,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif';
Chart.defaults.global.defaultFontColor = '#858796';
console.log('✅ Chart global font settings applied');
...
if (!ctx) {
  console.error('❌ Area Chart canvas element not found in DOM');
} else {
  console.log('✅ Area Chart canvas element found');
  ...
  var myLineChart = new Chart(ctx, {
    ...
    options: {
      ...
      animation: {
        onComplete: function() {
          console.log('✅ Area Chart animation completed');
        }
      },
      // Log when hover events occur
      onHover: function(event, elements) {
        if (elements && elements.length) {
          console.log(`👆 Chart hover at data point: ${elements[0]._index}`);
        }
      }
    }
  });
  
  console.log('✅ Area Chart successfully initialized');
}
